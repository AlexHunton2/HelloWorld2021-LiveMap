<?php
	class Database {
		...
		public function performTableQuery() { 
			$this->tables = array();
			$table_names = array();
			try {
				// Get tables names
		...
		public function update(string $tbname, array $values, array $tb_id) {
		...
		public function select(string $tbname, string $key_name, string $key_value, $pdo_fetch) {
			try {
		...
		public function delete(string $tbname, string $key_name, string $key_value) {
			try {
